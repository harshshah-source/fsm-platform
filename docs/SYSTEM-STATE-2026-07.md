...
1. **The SE mobile app** (PRD §SE-Mobile screens :479-663; workflow §11–§14): substantially built as
   ...
   screens, intra-day accept/decline (#54–#61, #63/#64/#66/#68/#71/#77, #81) are done.
   `.scratch/fsm-platform-v1/INDEX.md`'s Session log is the live status source — do not re-derive from
   this line. Still unbuilt: Notifications (#85), Leave request (#86), Availability (#87), Push (#89).
