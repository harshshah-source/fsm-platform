...
- 101 — Write-safety: `transitionOrConflict` helper + guarded transitions across ~8 racy state machines + inventory `qty` CHECK + concurrency tests → 100 *(audit #3, #11)*
- 102 — Install-lifecycle zone scoping (close cross-zone escalation) → *(audit #9)*
