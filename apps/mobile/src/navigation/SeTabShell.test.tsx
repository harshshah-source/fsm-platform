...
/**
 * #268 — retired the #77 intraday-offer gate and ghost-assignment toast (SE Acceptance no longer
 * exists on the CRITICAL path; #258 Q3). The shell now renders the tab navigator unconditionally, no
 * mount-time network check, no gated screen. `TicketsScreen.test.tsx` pins the replacement badge
 * behaviour (CRITICAL INSERTION derived from the ticket's own SLA bucket).
 */
describe('SeTabShell', () => {
