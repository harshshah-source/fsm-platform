...
- 119 — Plant deactivation semantics: FSM-owned flag + device/ticket effects; `plants.status` is sync-owned so manual flips get stomped; 6 STAR CEMENT rows waiting (disputed-claim caveat in `docs/audits/shutdown-plants-2026-07-13.md`) → —  *(needs-triage — HITL business decision; filed 2026-07-13)*
