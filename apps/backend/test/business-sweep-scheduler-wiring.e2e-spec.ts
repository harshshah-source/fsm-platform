 ...
 * Verification / Intraday / CrossZone / Ticketing / Reports) alongside ScheduleModule.forRoot(). This
 * fails if any needed service is unexported, a constructor arg is misordered, or the module forms a
 * cycle — and confirms all ten `@Cron` handlers are discovered and registered at boot.
 */
describe('Issue 108 — BusinessSweepSchedulerModule boots and registers every cron', () => {
  it('resolves the scheduler from the real DI graph and registers all ten named jobs', async () => {
